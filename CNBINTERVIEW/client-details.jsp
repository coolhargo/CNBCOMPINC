...
<title>Client Details - ADMINISTRATOR CONSOLE</title>
...
<script type='text/javascript'><!--
var IS_ARCHIVE=1;
function initFlyouts(){initPublishedFlyoutMenus([{"id":"405001969691813212","title":"Admin Home","url":"index.html"},{"id":"146674875957660501","title":"Client Details","url":"client-details.html"},{"id":"970458511180428576","title":"Company Details","url":"company-details.html"},{"id":"596971022672504363","title":"Change Password","url":"change-password.html"},{"id":"143461400384755254","title":"Logout","url":"logout.html"}],'146674875957660501',"<li class='wsite-nav-more'><a href='#'>more...<\/a><\/li>",'active',false)}
if (Prototype.Browser.IE) window.onload=initFlyouts; else document.observe('dom:loaded', initFlyouts);
//-->
</script>
</head>
<body class='wsite-page-client-details'>
<div id="wrapper">
		<div id="contents">
			<div id="navigation"><ul><li id='pg970458511180428576'><a href='admin-console.jsp'>Admin Home</a></li><li id='active'><a href='client-details.jsp'>Client Details</a></li><li id='pg970458511180428576'><a href='company-details.jsp'>Company Details</a></li><li id='pg596971022672504363'><a href='change-password.jsp'>Change Password</a></li><li id='pg143461400384755254'><a href='logout.jsp'>Logout</a></li></ul></div>
			<div id="header">
...
<h2  style=" text-align: left; ">Clients Registered so far&nbsp;..</h2>
      ...
      <td  valign="top"><table  cellpadding="0" width="830" height="109" border="0" align="left">
        <tr>
          <td height="31" colspan="16"   ><div align="center" class="style8 style63 style5">
           <font size ="4"> <p ><strong>Client Details </strong></p> </font>
            <p>&nbsp;</p>
          </div></td>
          </tr>
        <tr>
