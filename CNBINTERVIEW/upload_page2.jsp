...
For the SALES_ORDER_DETAIL Table, the NUMBER and RECNO (auto incremented number) fields combined create the UNIQUE record
 ...
 Transaction Date    Order Id    Transaction ID    Order State    SKU    Product    Product ID    Product Link    Product Image URL    Size    Color    Currency Code    Price (each)    Cost (each)    Shipping (each)    Shipping Cost (each)    Quantity    Total Cost    SE Cashback Amount    Available for Fulfillment Time    Shipped on    Confirmed Delivery    Date Shipping Carrier Confirmed Delivery    Provider    Tracking    Tracking Confirmed    Tracking Confirmed Date    Shipping Address    Name    First Name    Last Name    Street Address 1    Street Address 2    City    State    Zipcode    Country    Last Updated    Phone Number    Country Code    % Refund Responsibility    Refund Responsibility Amount    Refund Date    Refund Reason    Is Wish Express    Wish Express Delivery Deadline    Requires Delivery Confirmation    Advanced Logistics    Is Combined Order    PremiumCarrier Upgraded    Late Confirmed Fulfillment Fine Amount    Customer Identity Number    Final Product Price    Final Shipping Price    Final Total Product Price    Final Total Shipping Price    Final Total Price    Final Prices Currency    Is Replacement Order    Original Replacement Order ID    Fulfillment By Store (FBS) Order
...
SALES_ORDER_HEADER.CUST_PO_NO    FILE COLUMNS/Order Id                      WISHORDERS.OrderID
